...
\section{\slidecim}
\setfootline{What Do You Want from Me}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
...
\section{\slidecim}
\setfootline{A Saucerful of Secrets}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
    \item Adott:
...
\section{\slidecim}
\setfootline{Obscured by Clouds}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
    \item Előnyök:
...
\section{\slidecim}
\setfootline{Any Colour You Like}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{figure}[!ht]
\centering
...
\section{\slidecim}
\setfootline{Welcome to the Machine}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
\item VMware metrikák:
...
\frametitle{\slidecim}
\begin{itemize}
\item Az adathalmazunk:
    \begin{itemize}
        \item Egy PowerShell alapú szkript CSV-be exportálta a hostonként/guestenként mért metrikákat
        \item Kb. 1 hónapos mérési időszak
        \item 2 host, 6-4 guest OS (Windows, Linux vegyesen)
        \item 144 metrika, kb. 89 millió mérési pont, kb. 290 MB adat
    \end{itemize}
\item Előállított grafikonok:
    \begin{itemize}
        \item az összes metrika a mérési időintervallumon
        \item néhány kiválasztott metrikák közötti összefüggések
    \end{itemize}
\end{itemize}
\end{frame}
%#
...
%###############################################################################
%#
%#                    LEMEZ KÉSLELTETÉSEK SPECIÁLIS ESZKÖZÖKNÉL
%#
\renewcommand{\slidecim}{Lemezkésleltetések speciális eszközöknél}
\section{\slidecim}
\setfootline{In the Flesh?}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
    \item Mért metrika: disk.totallatency.average
    \item Specialitás: Flash meghajtó
\end{itemize}
\begin{figure}[!ht]
\centering
\includegraphics[width=110mm, keepaspectratio]{figures/all_metrics_disk_totallatency_average_mpx.png}
\end{figure}
\end{frame}
%#
%###############################################################################
...
%###############################################################################
%#
%#                    ÜTEMEZÉSEKKEL KAPCSOLATOS ESETLEGES PROBLÉMÁK - ELOSZLÁSOK
%#
\renewcommand{\slidecim}{Ütemezésekkel kapcsolatos esetleges problémák - Eloszlások}
\section{\slidecim}
\setfootline{On the Run}
\begin{frame}[t]
\frametitle{\slidecim}
\begin{itemize}
    \item Mért metrika: cpu.ready.summation
\end{itemize}
\begin{figure}[!ht]
\centering
\includegraphics[width=90mm, keepaspectratio]{figures/cpu_ready_summation-histogram-w-b.png}
\end{figure}
\end{frame}
%#
%###############################################################################
...
%###############################################################################
%#
%#                    ÜTEMEZÉSEKKEL KAPCSOLATOS ESETLEGES PROBLÉMÁK - MAX. ÉRTÉKEK
%#
\renewcommand{\slidecim}{Ütemezésekkel kapcsolatos esetleges problémák - Max. értékek}
\section{\slidecim}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=110mm, keepaspectratio]{figures/cpu_ready_summation-max-barchart.png}
\end{figure}
\end{frame}
%#
%###############################################################################
...
\section{\slidecim}
\setfootline{The Great Gig in the Sky}
\begin{frame}[c]
\frametitle{\slidecim}
Köszönet illeti
\begin{center}
